...
class OrderTile extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: StreamBuilder<DocumentSnapshot>(
          stream: Firestore.instance.collection('orders')
              .document(orderId)
              .snapshots(), //Snapshots é para retornar em formato de Stream
          builder: (context, snapshot) {
            if (!snapshot.hasData){
              ...
              return Column(
                ...
                children: <Widget>[
                  Text(
                    'Cód. Pedido:  ${snapshot.data.documentID}',
  ...
  String _buildProductsText(DocumentSnapshot snapshot){
    ...
    for (LinkedHashMap map in snapshot.data['products']){
      text += '${map['quantity']} x ${map['product']['title']} '
          'R\$ ${map['product']['price'].toStringAsFixed(2)}\n';
    }
